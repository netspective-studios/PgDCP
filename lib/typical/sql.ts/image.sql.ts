...
export function SQL(
  ...
  return SQLa.SQL(ctx, state)`
    ...
    sqr("inspect_image_meta_data")
  }(provenance text, image bytea) RETURNS ${sqr("image_meta_data")} AS $innerFn$
        ...
        comment on function ${
    sqr("inspect_image_meta_data")
  }(provenance text, image bytea) is 'Given a binary image, detect its format and size';
    ...
    sqr("inspect_image_meta_data")
            ...
            imgMD := ${
    sqr("inspect_image_meta_data")
  }('bytea://test3invalid', decode('F17CC6527070301B14D1F291716D2722909111','hex')::bytea);
