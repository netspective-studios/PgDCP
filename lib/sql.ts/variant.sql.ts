  ...
  return mod.SQL(ctx.engine, state)`
    ...
    BEGIN
        ...
        return format($execBody$
            ...
            create or replace function %1$s.insert_%2$s_secret_text() returns trigger as $genBody$
            declare
                %2$sId integer;
            begin
            ...
            create trigger insert_%2$s_secret_text_trigger
            instead of insert on %1$s.%2$s_secret_text
            for each row execute function %1$s.insert_%2$s_secret_text();
